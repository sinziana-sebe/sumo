/****************************************************************************/
/// @file    MSCFModel_Simple.h
/// @author  Sinziana Sebe
/// @date    Wed, 15 May 2017
/// @version 1
///
/// A simple car following model for autonomous vehicles based on https://goo.gl/L3p9ns
/****************************************************************************/
...
//
/****************************************************************************/
#ifndef MSCFModel_Simple_h
#define MSCFModel_Simple_h
...
// class definitions
// ===========================================================================
/** @class MSCFModel_Simple
 * @brief A simple car following model for autonomous vehicles
 * @see MSCFModel
 */
class MSCFModel_Simple : public MSCFModel {
public:
    /** @brief Constructor
     ...
     */
    MSCFModel_Simple(const MSVehicleType* vtype, double accel, double decel, 
	...
	double getSecureGap(const double speed, const double leaderSpeed, const double leaderMaxDecel, double ds) const {
		const double followDecel = MIN2(myDecel, leaderMaxDecel);
		double secureGap = ds + speed *myHeadwayTime+ (leaderSpeed*leaderSpeed)/(2*leaderMaxDecel)-(speed*speed)/(2*myDecel);
		return secureGap;
